...
type RouteInput = Omit<
  EcoGovRouteDefinition,
  "label" | "group" | "breadcrumb" | "order" | "visibleInNavigation"
>;
...
> = {
  ...
  "verify-licence": {
    ...
    group: "marketplace",
    breadcrumb: ["Marketplace", "Verify Licence"],
    order: 17,
    visibleInNavigation: false,
  },
  "accept-invitation": {
  ...
  "users-access": {
    label: "Users & Access",
    group: "administration",
    breadcrumb: ["Administration", "Users & Access"],
    order: 21,
    visibleInNavigation: true,
  },
  "account-security": {
  ...
  "user-security": {
    label: "User Security",
    group: "administration",
    breadcrumb: ["Administration", "Users & Access", "Security"],
    order: 23,
    visibleInNavigation: false,
  },
  organizations: {
    label: "Organizations",
    group: "administration",
    breadcrumb: ["Administration", "Organizations"],
    order: 24,
    visibleInNavigation: true,
  },
  "organization-detail": {
    label: "Organization",
    group: "administration",
    breadcrumb: ["Administration", "Organizations", "Organization"],
    order: 25,
    visibleInNavigation: false,
  },
  "workflow-definitions": {
    ...
    group: "administration",
    breadcrumb: ["Administration", "Workflows", "Definitions"],
    order: 26,
    visibleInNavigation: true,
  },
  "workflow-instances": {
    ...
    group: "administration",
    breadcrumb: ["Administration", "Workflows", "Instances"],
    order: 27,
    visibleInNavigation: true,
  },
  "workflow-tasks": {
  ...
  "workflow-operations": {
    ...
    group: "administration",
    breadcrumb: ["Administration", "Workflows", "SLA & Escalations"],
    order: 29,
    visibleInNavigation: true,
  },
  denied: {
...
const defineRoute = (route: RouteInput): EcoGovRouteDefinition => ({
  ...routeMetadata[route.id],
  ...route,
});
...
export const routesRegistry: readonly EcoGovRouteDefinition[] = (
  [
    ...
    {
      id: "subcontractor-status",
      path: "#/marketplace/status/:applicationId",
      accessBoundary: "public",
      implementationStatus: "available",
    },
    {
    ...
    },
    {
      ...
      path: INVITATION_ACCEPTANCE_HASH_ROUTE,
      accessBoundary: "public",
      implementationStatus: "available",
    },
    {
    ...
    {
      id: "user-security",
      path: "#/administration/users/:userId/security",
      accessBoundary: "authenticated",
      requiredPermission: "user:read",
      implementationStatus: "available",
    },
    ...
    },
    {
      ...
      path: "#/administration/workflow-instances",
      accessBoundary: "authenticated",
    ...
    },
    {
      ...
      path: "#/administration/workflow-operations",
      accessBoundary: "authenticated",
...
export const LEGACY_TAB_ROUTES: Readonly<
  Record<Exclude<AppTab, "denied">, string>
> = {
  dashboard: "#/dashboard",
  registry: "#/facilities",
  ...
  "workflow-definitions": "#/administration/workflows",
  "workflow-instances": "#/administration/workflow-instances",
  "workflow-tasks": "#/workflows/tasks",
  "workflow-operations": "#/administration/workflow-operations",
  "subcontractor-apply": "#/subcontractor-apply",
...
export function validateAndStoreRedirect(targetHash: string): boolean {
  ...
  if (
    !match ||
    match.route.accessBoundary === "public" ||
    match.route.id === "denied"
  )
    return false;
...
export function resolveRoute(input: {
  ...
  if (
    match.route.accessBoundary === "platform_admin" &&
    !input.canAccessPlatformAdmin
  ) {
    return {
      tab: "denied",
      hash: "#/_denied",
  ...
  if (
    ...
    !input.permissions.includes(match.route.requiredPermission)
  ) {
    return {
      tab: "denied",
      hash: "#/_denied",
