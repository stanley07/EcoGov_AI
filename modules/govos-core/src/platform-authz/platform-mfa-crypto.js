...
export function encryptMfaSecret(userId, secret, keyHex, keyId = "v1") {
...
export function decryptMfaSecret(userId, envelope, keyHex) {
...
export function hashRecoveryCode(userId, code, pepperHex, pepperId) {
...
export function verifyAndConsumeRecoveryCode(userId, code, storedJSON, peppers) {
...
//# sourceMappingURL=platform-mfa-crypto.js.map